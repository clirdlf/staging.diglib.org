...
<head>
	...
	<title>DLF Coming Soon</title>

    <link name="author" href="CLIR" />
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<ul class="connect-us row fade-down">
			<li><a href="https://www.facebook.com/pages/Digital-Library-Federation/120568318151192" class="fb tool-tip" title="Facebook"><i class="fa fa-facebook"></i></a></li>
			<li><a href="http://twitter.com/#!/CLIRDLF" class="twitter tool-tip" title="Twitter"><i class="fa fa-twitter"></i></a></li>
			<li><a href="http://www.linkedin.com/groups?mostPopular=&gid=3387265" class="linkedin tool-tip" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
			<li><a href="http://www.youtube.com/user/DLFCLIR" class="ytube tool-tip" title="You Tube"><i class="fa fa-youtube-play"></i></a></li>
		</ul>
		<!-- Social icons end here -->
		<!-- Footer start here -->
		<footer class="fade-down">
			<p class="footer-text">&copy; CLIR 2016, All Rights Reserved. Made with love</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
  <div class="modal fade bs-example-modal-lg" role="dialog" aria-hidden="true" data-keyboard="true" data-backdrop="static" tabindex="-1">
    ...
    <div class="modal-dialog modal-lg clearfix">
      <div class="modal-content pop-up">
        ...
        <div class="clearfix">
        <div>
          <p>Strategy meets practice at the Digital Library Federation (DLF). Through its programs, working groups, and initiatives, DLF connects the vision and research agenda of its parent organization, the Council on Library and Information Resources (CLIR), to an active and exciting network of practitioners working in digital libraries, archives, labs, and museums. DLF is a place where ideas can be road-tested, and from which new strategic directions can emerge.</p>
        </div>
      </div>
      </div>
    </div>
